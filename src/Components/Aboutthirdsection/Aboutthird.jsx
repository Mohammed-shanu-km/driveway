...
const Aboutthird = () => {
  return (
    <div className="pl-[0px] pt-[0px] pb-[30px] h-[90vh]  bg-[#edf2f6] flex flex-row-reverse gap-[100px] relative md-max:h-[55vh]  sm-max:h-[auto] md-small:flex-col-reverse md-small:h-[100vh] md-small:gap-[40px] sm-max:flex-col-reverse  sm-max:gap-[10px]">
